    ...
    public class EnrollmentServices : IEnrollmentServices
    {
        ...
        public async Task<IEnumerable<Enrollment>> GetAllAsync()
        {
            ...
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await cl.GetAsync("api/Enrollments");
        ...
        //No se implementa ya que el api este metodo no lo contiene 
        public async Task<Enrollment> GetOneByIdAsync(int id)
        {
            Models.Enrollment aux = new Models.Enrollment();
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await cl.GetAsync("api/Enrollments/" + id);
